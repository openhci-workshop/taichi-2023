    ...
    return (
        <>
            <div className={classnames(styles.sectionHero, 'flex item-start md:items-center relative')}>
                ...
                <div className="flex-1 flex justify-center items-center">
                    <div className="m-50 pt-50">
                        <Image src={cubelogo} alt="logo-cube" style={{ width: '50%', height: 'auto', transform: 'scale(1.8)' }} />
                    </div>
                </div>
            </div>
            ...
            <div className="flex justify-between m-10">
                ...
                <div className="w-1/2 flex flex-row justify-center items-center"> {/* Right div */}
                    <div className='m-5'>
