...
export const metadata = {
	title: 'TAICHI 2023 Keynote',
	description: 'TAICHI 2023 Keynote',
	keywords: '',
};
					...
					{content?.map(_content =>
						typeof _content === 'string' ? (
							<p
								key={_content}
								dangerouslySetInnerHTML={{ __html: _content }}
								className="text-xs md:text-lg text-white leading-loose font-normal tracking-wide"
							/>
						) : (
							renderHTML(_content.type, _content.content, _content.level)
						)
					...
					{content?.map(_content =>
						typeof _content === 'string' ? (
							<p
								key={_content}
								dangerouslySetInnerHTML={{ __html: _content }}
								className={classnames(aldrich.className, "text-xs md:text-lg text-white leading-loose font-normal tracking-wide")}
							/>
						) : (
							renderHTML(_content.type, _content.content, _content.level)
						)
